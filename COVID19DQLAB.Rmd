...
Akhirnya Anda berhasil menjinakan data `cov_jabar` sehingga lebih mudah untuk diolah. Memiliki data yang rapi memang menyenangkan, apakah Anda setuju dengan hal tersebut?

Setelah memiliki data yang jinak, sekarang saatnya Anda mengekspresikan data tersebut dalam bentuk lain yang harapannya lebih mudah dicerna. Anda akan memulai merancang visualisasi yang memiliki estetika dengan menggunakan paket ggplot2 dan paket hrbrthemes. Aktifkanlah kedua paket tersebut!
...
1. Apakah jumlah kasus di pekan ini lebih rendah dibandingkan pekan kemarin dan dua pekan kemarin secara berturut-turut? Buatlah visualisasinya!

2. Salah satu metrik yang dapat dihitung untuk mengamati persebaran COVID-19 di masyarakat adalah 'Seventh-Day Amplification Factor' (silakan baca ini dan ini). Dapatkah Anda menghitung metrik tersebut?
